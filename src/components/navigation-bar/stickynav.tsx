      ...
      <NavigationMenu.Root className="relative z-[1] flex w-full">
        <NavigationMenu.List className="m-0 flex list-none rounded-[6px] bg-transparent p-1 ">
          <NavigationMenu.Item>
            ...
            <NavigationMenu.Content className="data-[motion=from-start]:animate-enterFromLeft data-[motion=from-end]:animate-enterFromRight data-[motion=to-start]:animate-exitToLeft data-[motion=to-end]:animate-exitToRight absolute top-0 left-0 w-auto  bg-red-500">
              <ul className="one m-0 grid list-none gap-x-[10px] p-[22px] w-[400px] sm:w-[500px] sm:grid-cols-[0.75fr_1fr]">
        ...
        <NavigationMenu.Viewport className="relative mt-[10px] h-[var(--radix-navigation-menu-viewport-height)] origin-[top_center] overflow-hidden rounded-[6px]  transition-[width,_height] duration-300 w-[400px] sm:w-[var(--radix-navigation-menu-viewport-width)]" />
        </div>
      </NavigationMenu.Root>
    );
  };
